...
{
    [TestClass]
    public class SLIDESNET_44406

    {
        [TestMethod]
        public void Test_44406()
        {
            var RootDirectory = Path.GetFullPath("../../../");
            var PresentationFilePath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_44406", "SLIDESNET-44406.pptx");
            var EthalonPath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_44406", "html");
            var TemplatePath = Path.Combine(RootDirectory, "TestData", "Out", "templates");
            var OutputPath = Path.Combine(RootDirectory, "TestData", "Out", "SLIDESNET_44406");
