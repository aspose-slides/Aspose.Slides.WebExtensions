...
{
    [TestClass]
    public class SLIDESNET_43203
    {
        [TestMethod]
        public void Test_43203()
        {
            var RootDirectory = Path.GetFullPath("../../../");
            var PresentationFilePath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_43203", "SLIDESNET-43203.pptx");
            var EthalonPath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_43203", "html");
            var TemplatePath = Path.Combine(RootDirectory, "TestData", "Out", "templates");
            var OutputPath = Path.Combine(RootDirectory, "TestData", "Out", "SLIDESNET_43203");
